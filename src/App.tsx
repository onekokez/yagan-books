...
const INITIAL_BOOKS: Book[] = [
  { id: 1, title: "အောင်မြင်သူများ၏ အလေ့အကျင့်", author: "Stephen Covey", category: "free", type: "ebook", cover: "📗", price: 0, rating: 4.8, reads: 12400, description: "အောင်မြင်သူများ၏ အဓိကအလေ့အကျင့် ၇ ခုကို လေ့လာပါ။ ဘဝတွင် အောင်မြင်ရန် လမ်းညွှန်ချက်တစ်ခု။", pages: 320, lang: "မြန်မာဘာသာ", tag: "Bestseller" },
  { id: 2, title: "ငွေကြေးဉာဏ်ပညာ", author: "Robert Kiyosaki", category: "premium", type: "ebook", cover: "📘", price: 3500, rating: 4.9, reads: 9800, description: "ချမ်းသာကြွယ်ဝမှုဆီသို့ ဦးတည်သော ငွေကြေးစီမံခန့်ခွဲမှု လမ်းညွှန်ချက်။", pages: 280, lang: "မြန်မာဘာသာ", tag: "Popular" },
  { id: 3, title: "စိတ်ဓာတ်ခွန်အား", author: "Norman Peale", category: "free", type: "ebook", cover: "📙", price: 0, rating: 4.7, reads: 15600, description: "အပြုသဘောဆောင်သောစိတ်ဓာတ်ဖြင့် ဘဝကို ပြောင်းလဲပါ။", pages: 240, lang: "မြန်မာဘာသာ", tag: "Free" },
  { id: 4, title: "အိပ်မက်ကို လိုက်နာပါ", author: "Paulo Coelho", category: "premium", type: "ebook", cover: "📕", price: 2500, rating: 4.6, reads: 7200, description: "ကိုယ်ပိုင်ဒဏ္ဍာရီကို ရှာဖွေခြင်းနှင့် ဘဝ၏ စစ်မှန်သောအဓိပ္ပါယ်ကို ရှာဖွေပါ။", pages: 180, lang: "မြန်မာဘာသာ", tag: "New" },
  { id: 5, title: "အောင်မြင်သောခေါင်းဆောင်ပုံစံ", author: "John Maxwell", category: "free", type: "audiobook", cover: "🎧", price: 0, rating: 4.9, reads: 6800, description: "ခေါင်းဆောင်မှုစွမ်းရည်ကို မြှင့်တင်ရန် audio သင်ခန်းစာများ။", duration: "8 နာရီ 30 မိနစ်", lang: "မြန်မာဘာသာ", tag: "Audio" },
  { id: 6, title: "Atomic Habits မြန်မာဘာသာ", author: "James Clear", category: "premium", type: "audiobook", cover: "🎙️", price: 4500, rating: 5.0, reads: 11200, description: "ထူးခြားသောကောင်းသောအလေ့အကျင့်များ တည်ဆောက်ရန် လမ်းညွှန်ချက်အပြည့်အစုံ။", duration: "11 နာရီ 15 မိနစ်", lang: "မြန်မာဘာသာ", tag: "Premium" },
  { id: 7, title: "ဆန်းသစ်တီထွင်ခြင်း", author: "Walter Isaacson", category: "premium", type: "ebook", cover: "💡", price: 3000, rating: 4.7, reads: 5400, description: "Steve Jobs ၏ ဆန်းသစ်တီထွင်သောနည်းလမ်းများ၊ ယနေ့ကမ္ဘာကို ပြောင်းလဲပုံ။", pages: 350, lang: "မြန်မာဘာသာ", tag: "Trending" },
  { id: 8, title: "ဘဝတွင် ရပ်တည်ပါ", author: "Brené Brown", category: "free", type: "audiobook", cover: "🌟", price: 0, rating: 4.8, reads: 8900, description: "ကြောက်ရွံ့မှုကို ကျော်ဖြတ်ကာ ရဲရင့်သောဘဝကို ရှင်သန်ပါ။", duration: "6 နာရီ 45 မိနစ်", lang: "မြန်မာဘာသာ", tag: "Free Audio" },
];
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          --gold: #D4AF37; --gold-light: #F4D03F; --gold-dark: #A0840A;
          --ruby: #8B1A1A; --ruby-light: #B22222;
          --deep: #0A0408; --dark: #120C10; --panel: #1A1018; --card: #1E1320;
          --border: rgba(212,175,55,0.25); --text: #F5EDD8; --muted: #9A8870;
          --emerald: #1B4D3E; --sapphire: #1B2F4D; --glow: rgba(212,175,55,0.15);
        }
        ...
        .nav-logo { font-family: 'Cinzel', serif; font-size: 1.4rem; font-weight: 900; background: linear-gradient(135deg, var(--gold-light), var(--gold), var(--gold-dark)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; letter-spacing: 2px; }
        ...
        .admin-toggle { background: linear-gradient(135deg, var(--ruby), var(--ruby-light)); color: white; border: none; cursor: pointer; padding: 0.45rem 1rem; border-radius: 20px; font-size: 0.75rem; font-family: 'Noto Sans Myanmar', sans-serif; transition: all 0.25s; box-shadow: 0 2px 12px rgba(139,26,26,0.4); }
        ...
        .modal-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.85); backdrop-filter: blur(12px); z-index: 200; display: flex; align-items: center; justify-content: center; padding: 2rem; animation: fadeIn 0.25s ease; }
        ...
        .modal-hero { height: 240px; display: flex; align-items: center; justify-content: center; font-size: 9rem; position: relative; background: linear-gradient(135deg, var(--deep), var(--sapphire), var(--dark)); border-radius: 24px 24px 0 0; }
        ...
        .btn-get { width: 100%; padding: 1rem; border-radius: 12px; border: none; cursor: pointer; font-family: 'Noto Sans Myanmar', sans-serif; font-size: 1rem; font-weight: 700; transition: all 0.3s; }
        ...
        .admin-form-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.9); backdrop-filter: blur(16px); z-index: 300; display: flex; align-items: center; justify-content: center; padding: 2rem; animation: fadeIn 0.25s ease; }
        .admin-form { background: var(--panel); border: 1px solid var(--gold); border-radius: 24px; max-width: 560px; width: 100%; max-height: 90vh; overflow-y: auto; animation: slideUp 0.35s cubic-bezier(0.34, 1.56, 0.64, 1); }
        ...
        .form-input, .form-select, .form-textarea { background: rgba(30,19,32,0.8); border: 1px solid var(--border); color: var(--text); padding: 0.75rem 1rem; border-radius: 10px; font-family: 'Noto Sans Myanmar', sans-serif; font-size: 0.88rem; outline: none; transition: border-color 0.25s; width: 100%; }
        ...
        .add-book-btn { background: white; color: var(--ruby); border: none; cursor: pointer; padding: 0.5rem 1.2rem; border-radius: 50px; font-size: 0.82rem; font-weight: 700; font-family: 'Noto Sans Myanmar', sans-serif; transition: all 0.25s; }
        .add-book-btn:hover { background: var(--gold-light); transform: scale(1.05); }
        .toast { position: fixed; bottom: 6rem; left: 50%; transform: translateX(-50%); background: rgba(27,77,62,0.95); border: 1px solid rgba(78,205,196,0.4); color: #A7F3D0; padding: 0.75rem 1.5rem; border-radius: 50px; font-size: 0.85rem; z-index: 999; backdrop-filter: blur(12px); animation: toastIn 0.35s cubic-bezier(0.34, 1.56, 0.64, 1); }
        ...
        .admin-login { position: fixed; inset: 0; background: rgba(0,0,0,0.95); backdrop-filter: blur(20px); z-index: 400; display: flex; align-items: center; justify-content: center; animation: fadeIn 0.25s ease; }
        .admin-login-box { background: var(--panel); border: 1px solid var(--gold); border-radius: 24px; padding: 2.5rem; max-width: 380px; width: 100%; text-align: center; animation: slideUp 0.35s cubic-bezier(0.34,1.56,0.64,1); }
      ...
      <div className="site-bg">
          ...
          <div className="nav-links">
            {(["home","library","categories"] as const).map((v) => (
              <button key={v} className={`nav-btn ${view===v?"active":""}`} onClick={() => setView(v)}>
                {v==="home"?"မူလစာမျက်နှာ":v==="library"?"စာကြည့်တိုက်":"အမျိုးအစားများ"}
              </button>
            ))}
            <button className="admin-toggle" onClick={() => {
              if (adminUnlocked) { setAdminMode(!adminMode); }
        ...
        {adminMode && !adminUnlocked && (
          <div className="admin-login">
            <div className="admin-login-box">
              ...
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.5rem", fontWeight: 700, color: "var(--gold)", marginBottom: "0.5rem" }}>Admin Login</div>
              <div style={{ fontSize: "0.82rem", color: "var(--muted)", marginBottom: "2rem" }}>ဝင်ရောက်ရန် password ထည့်ပါ</div>
              <input type="password" className="form-input" placeholder="Password" value={adminPass}
                onChange={(e) => { setAdminPass(e.target.value); setPassError(false); }}
                onKeyDown={(e) => { if (e.key === "Enter") { if (adminPass === "admin123") setAdminUnlocked(true); else setPassError(true); } }}
                style={{ marginBottom: "1rem" }} />
              {passError && <div style={{ color: "#F77", fontSize: "0.8rem", marginBottom: "1rem" }}>Password မှားနေပါသည်</div>}
              <button className="btn-primary" style={{ width: "100%" }} onClick={() => { if (adminPass === "admin123") setAdminUnlocked(true); else setPassError(true); }}>ဝင်ရောက်မည်</button>
              <button className="btn-outline" style={{ width: "100%", marginTop: "0.75rem" }} onClick={() => { setAdminMode(false); setAdminPass(""); }}>မလုပ်တော့ပါ</button>
              <div style={{ marginTop: "1rem", fontSize: "0.72rem", color: "rgba(154,136,112,0.6)" }}>Default: admin123</div>
            </div>
          </div>
        )}
          ...
          <>
            <section className="hero">
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div className={`hero-actions ${heroAnim ? "show" : ""}`}>
                  ...
                  <button className="btn-outline" onClick={() => setView("categories")}>🎯 အမျိုးအစားများ</button>
                </div>
              </div>
            </section>

            <div className="stats-bar">
              <div className="stat-item"><div className="stat-num">{stats.total}+</div><div className="stat-label">📚 စာအုပ်စုစုပေါင်း</div></div>
              <div className="stat-item"><div className="stat-num">{stats.free}</div><div className="stat-label">🆓 အခမဲ့ Ebooks</div></div>
              <div className="stat-item"><div className="stat-num">{stats.premium}</div><div className="stat-label">👑 Premium Ebooks</div></div>
              <div className="stat-item"><div className="stat-num">{stats.audio}</div><div className="stat-label">🎧 Audio Books</div></div>
            </div>

            <div className="marquee-wrap">
              <div className="marquee-inner">
                {[...Array(2)].map((_, di) => books.map((b, i) => (
                  <span key={`${di}-${i}`} className="marquee-item"><span className="marquee-dot">✦</span> {b.title}</span>
                )))}
              </div>
            </div>
            ...
            <section className="section">
              ...
              <div className="cat-grid">
                <div className="cat-card cat-free" onClick={() => { setView("library"); setFilter("free"); }}>
                  ...
                  <div className="cat-desc">ကောင်းမွန်သော စာအုပ်များကို အခမဲ့ ဖတ်ရှုပါ</div>
                ...
                <div className="cat-card cat-premium" onClick={() => { setView("library"); setFilter("premium"); }}>
                  ...
                  <div className="cat-desc">ထူးချွန်သောအကြောင်းအရာများကို ဝင်ရောက်ကြည့်ပါ</div>
                ...
                <div className="cat-card cat-audio" onClick={() => { setView("library"); setFilter("audiobook"); }}>
                  ...
                  <div className="cat-desc">နားထောင်ရင်း သင်ယူပါ၊ ဘယ်နေရာမှာမဆို</div>
            ...
            <div className="featured-band">
              <div className="featured-inner">
                <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
                  ...
                  <h2 className="section-title">ဂုဏ်သတင်းကြီးမားသော အကြံပြုစာအုပ်</h2>
                  <div className="gold-divider" />
                </div>
                <div className="featured-book">
                  ...
                  <div>
                    ...
                    <div className="featured-desc">ချမ်းသာကြွယ်ဝရေးသို့ ဦးတည်သောကြောင်း ငွေကြေးစီမံခန့်ခွဲမှု၊ ရင်းနှီးမြှုပ်နှံမှု နှင့် ဝင်ငွေတိုးပွားစေရန် နည်းလမ်းများ ပါဝင်သောစာအုပ်ကြီး မြန်မာဘာသာသို့ ဘာသာပြန်ထားသောအကျဉ်းချုပ်။</div>
                    <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                      <button className="btn-primary" onClick={() => setSelectedBook(books[1])}>📖 ဖတ်ရှုမည်</button>
                      <button className="btn-outline" onClick={() => setView("library")}>📚 နောက်ထပ်ကြည့်မည်</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="section">
              ...
              <div className="books-grid">
                {books.slice(0, 4).map((book, i) => (
                  <BookCard key={book.id} book={book} onSelect={setSelectedBook} adminMode={adminMode && adminUnlocked} onEdit={(b: Book) => setAdminForm(b)} onDelete={handleDelete} animDelay={`${i*0.1}s`} />
                ))}
              </div>
              <div style={{ textAlign: "center", marginTop: "2.5rem" }}>
                <button className="btn-outline" onClick={() => setView("library")}>📚 ကျန်သောစာအုပ်များကြည့်မည်</button>
              </div>
            </section>
            ...
            <footer className="footer">
              ...
              <div className="footer-links">
                <span className="footer-link" onClick={() => setView("home")}>မူလစာမျက်နှာ</span>
                <span className="footer-link" onClick={() => setView("library")}>စာကြည့်တိုက်</span>
                <span className="footer-link" onClick={() => setView("categories")}>အမျိုးအစားများ</span>
              </div>
              <div className="gold-divider" style={{ marginBottom: "1.5rem" }} />
              <div className="footer-copy">© 2025 Yagan Books. မြန်မာနိုင်ငံ မှ ❤️ ဖြင့် ဖန်တီးထားသည်</div>
            </footer>
          </>
        )}
          ...
          <div className="section" style={{ paddingTop: "7rem" }}>
            ...
            <div className="books-grid">
              {filteredBooks.map((book, i) => (
                <BookCard key={book.id} book={book} onSelect={setSelectedBook} adminMode={adminMode && adminUnlocked} onEdit={(b: Book) => setAdminForm(b)} onDelete={handleDelete} animDelay={`${i*0.07}s`} />
              ))}
            </div>
          ...
          <div className="section" style={{ paddingTop: "7rem" }}>
            ...
            <div className="cat-grid" style={{ marginBottom: "4rem" }}>
              <div className="cat-card cat-free" onClick={() => { setView("library"); setFilter("free"); }}>
                ...
                <div className="cat-desc">မှတ်ပုံတင်ရန် မလိုဘဲ အခမဲ့ ဖတ်ရှုနိုင်သော စာအုပ်များ</div>
                <div className="cat-count">{books.filter(b=>b.category==="free").length}+</div>
              </div>
              <div className="cat-card cat-premium" onClick={() => { setView("library"); setFilter("premium"); }}>
                <span className="cat-icon">👑</span>
                <div className="cat-name">Premium Ebooks</div>
                <div className="cat-desc">ထူးခြားသောနှင့် ငွေကြေးဆိုင်ရာ အကျဉ်းချုပ် e-books</div>
                <div className="cat-count">{books.filter(b=>b.category==="premium").length}+</div>
              </div>
              <div className="cat-card cat-audio" onClick={() => { setView("library"); setFilter("audiobook"); }}>
                <span className="cat-icon">🎧</span>
                <div className="cat-name">Audio Books</div>
                <div className="cat-desc">ကားပေါ်မှာ ၊ အိပ်ရာဝင်ချိန်ကြည့်ရာ နားထောင်ရန် audio books</div>
                <div className="cat-count">{books.filter(b=>b.type==="audiobook").length}+</div>
              </div>
            </div>
            <div className="section-header">
        ...
        {adminMode && adminUnlocked && (
          <div className="admin-bar">
            ...
            <button className="add-book-btn" onClick={() => setAdminForm({ id: 0, title: "", author: "", category: "free", type: "ebook", cover: "📗", price: 0, rating: 4.5, reads: 0, description: "", pages: 0, lang: "မြန်မာဘာသာ", tag: "New", duration: "" })}>
              + စာအုပ်အသစ်ထည့်မည်
            </button>
            <button style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", color: "white", borderRadius: "50px", padding: "0.5rem 1rem", cursor: "pointer", fontSize: "0.78rem" }}
              onClick={() => { setAdminMode(false); setAdminUnlocked(false); setAdminPass(""); }}>
              ✕ ထွက်မည်
            </button>
          </div>
        )}
...
function getCoverClass(book: Book) {
...
function getTagClass(tag: string) {
  ...
  if (t.includes("premium") || t === "popular" || t === "bestseller") return "tag-premium";
  if (t.includes("audio")) return "tag-audio";
  return "tag-new";
}

function BookCard({ book, onSelect, adminMode, onEdit, onDelete, animDelay }: {
  book: Book; onSelect: (b: Book) => void; adminMode: boolean;
  onEdit: (b: Book) => void; onDelete: (id: number) => void; animDelay: string;
}) {
  return (
    <div className="book-card" style={{ animationDelay: animDelay }} onClick={() => onSelect(book)}>
      ...
      {adminMode && (
        <div className="admin-actions" onClick={(e) => e.stopPropagation()}>
          <button className="admin-btn edit-btn" onClick={() => onEdit(book)}>✏️ ပြင်မည်</button>
          <button className="admin-btn del-btn" onClick={() => { if(window.confirm("ဖျက်မှာ သေချာပါသလား?")) onDelete(book.id); }}>🗑️ ဖျက်မည်</button>
        </div>
      )}
    </div>
  );
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="modal-tags">
            <span className="modal-tag">{book.type === "audiobook" ? "🎧 Audio Book" : "📖 Ebook"}</span>
            <span className="modal-tag">{book.category === "free" ? "🆓 Free" : "👑 Premium"}</span>
            <span className="modal-tag">🌐 {book.lang}</span>
            <span className={`book-tag ${getTagClass(book.tag)}`} style={{ position: "relative", top: 0, right: 0 }}>{book.tag}</span>
          </div>
          ...
          <div className="modal-stats">
            ...
            <div className="modal-stat"><div className="modal-stat-val">{(book.reads/1000).toFixed(1)}k</div><div className="modal-stat-label">ဖတ်ပြီးသူ</div></div>
          ...
          <button className={`btn-get ${book.price === 0 ? "btn-get-free" : "btn-get-premium"}`}>
            {book.price === 0 ? (book.type === "audiobook" ? "🎧 အခမဲ့ နားထောင်မည်" : "📖 အခမဲ့ ဖတ်မည်") : `👑 ${book.price.toLocaleString()} ကျပ် - ဝယ်ယူမည်`}
          </button>
        </div>
      </div>
    </div>
...
function AdminForm({ form, onChange, onSave, onClose }: {
  form: Book; onChange: (b: Book) => void; onSave: (b: Book) => void; onClose: () => void;
}) {
    ...
    <div className="admin-form-overlay" onClick={onClose}>
      <div className="admin-form" onClick={(e) => e.stopPropagation()}>
        <div className="form-header">
          <div className="form-title">{form.id ? "✏️ စာအုပ်ပြင်မည်" : "➕ စာအုပ်အသစ်ထည့်မည်"}</div>
          <button className="modal-close" onClick={onClose}>✕</button>
        </div>
        <div className="form-body">
          <div className="form-group">
            <label className="form-label">📚 စာအုပ်အမည်</label>
            <input className="form-input" value={form.title} onChange={(e) => set("title", e.target.value)} placeholder="စာအုပ်အမည်ထည့်ပါ..." />
          </div>
          <div className="form-row">
            <div className="form-group">
              <label className="form-label">✍️ စာရေးဆရာ</label>
              <input className="form-input" value={form.author} onChange={(e) => set("author", e.target.value)} placeholder="Author..." />
            </div>
            <div className="form-group">
              <label className="form-label">🎭 Icon/Cover</label>
              <input className="form-input" value={form.cover} onChange={(e) => set("cover", e.target.value)} placeholder="Emoji..." />
            </div>
          </div>
          <div className="form-row">
            <div className="form-group">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input className="form-input" value={form.tag} onChange={(e) => set("tag", e.target.value)} placeholder="New, Hot..." />
            </div>
          </div>
          {form.type === "ebook"
            ? <div className="form-group"><label className="form-label">📄 စာမျက်နှာ</label><input className="form-input" type="number" value={form.pages || 0} onChange={(e) => set("pages", +e.target.value)} /></div>
            : <div className="form-group"><label className="form-label">⏱️ ကြာချိန်</label><input className="form-input" value={form.duration || ""} onChange={(e) => set("duration", e.target.value)} placeholder="8 နာရီ 30 မိနစ်" /></div>
          }
          <div className="form-group">
            <label className="form-label">📝 ဖော်ပြချက်</label>
            <textarea className="form-textarea" value={form.description} onChange={(e) => set("description", e.target.value)} placeholder="စာအုပ်အကြောင်း ဖော်ပြပါ..." />
          </div>
